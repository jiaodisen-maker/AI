---
name: ecom-live-xiaohongshu-broadcast
description: |
  小红书直播 SOP。千帆开播 + 种草型话术 + 蒲公英联投 + 粉丝群通知。
allowed-tools: [Bash, Read, Write, WebFetch, AskUserQuestion]
triggers: [小红书直播 SOP]
ecom: { domain: 05-live-commerce, role: 运营, frequency: per-live-session }
---

# live-xiaohongshu-broadcast
...
## 参考 v0 规范
/home/user/AI/skills/05-live-commerce/live-xiaohongshu-broadcast/
