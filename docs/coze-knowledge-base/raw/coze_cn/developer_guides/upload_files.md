---
source_url: https://docs.coze.cn/developer_guides/upload_files
title: '上传文件 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:21:45Z
---
...
权限​| uploadFile​确保调用该接口使用的访问令牌开通了 uploadFile 权限，详细信息参考[鉴权方式](<https://docs.coze.cn/developer_guides/authentication>)。​  
接口说明​| 调用接口上传文件到扣子编程。​  
...
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
data​| Object of [File](<https://docs.coze.cn/developer_guides/upload_files#file>)​| { "bytes": 152236, "created_at": 1715847583, "file_name": "1120.jpeg", "id": "736949598110202****" }​| 已上传的文件信息。​  
