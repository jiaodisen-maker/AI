---
source_url: https://docs.coze.cn/developer_guides/create_message
title: '创建消息 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:20:40Z
---
...
权限​| createMessage​确保调用该接口使用的访问令牌开通了 createMessage 权限，详细信息参考[鉴权方式](<https://docs.coze.cn/developer_guides/authentication>)。​  
...
content_type​| String​| 必选​| text​| 消息内容的类型，支持设置为：​
...
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
data​| Object of [OpenMessageApi](<https://docs.coze.cn/developer_guides/create_message#openmessageapi>)​| { "role": "user", "content": "[{\"type\":\"text\",\"text\":\"帮我看看这个图片里有什么内容？\"},{\"type\":\"image\",\"file_id\":\"7380331280292495370\"}]" "content_type": "object_string" }​| 消息的详情。​  
detail​| Object of [ResponseDetail](<https://docs.coze.cn/developer_guides/create_message#responsedetail>)​| { "logid": "20250106172024B5F607030EFFAD653960" }​| 响应详情。​  
