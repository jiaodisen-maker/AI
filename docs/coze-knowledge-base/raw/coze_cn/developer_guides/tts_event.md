---
source_url: https://docs.coze.cn/developer_guides/tts_event
title: '双向流式语音合成事件 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:22:18Z
---
...
data.output_audio.pcm_config​| Object​| 可选​| 当 codec 设置为 opus 时，不需要设置此字段。​说明当 codec 设置为 pcm 时，返回的 PCM 数据将固定为单声道，采样深度为 16 位。​​  
...
data.output_audio.voice_id​| String​| 可选​| 输出音频的音色 ID。默认音色为"柔美女友"。你可以调用​查看音色列表 API 查看当前可用的所有音色 ID。​  
