---
source_url: https://docs.coze.cn/developer_guides/coze_error_codes
title: '错误码 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:24:44Z
---
...
4001​| Invalid chat（包括chat id错误，chat 找不到）​| 
...
4002​| invalid conversation（包括conversation id错误，conversation 找不到）​| 
...
4005​| invalid message（包括message id错误，message content错误）​| 
...
4006​| invalid bot（包括bot id错误，bot 找不到）​| 
...
4201​| 企业/团队人员已存在，请勿重复添加。​组织成员已经存在，请不要重复加入。​| 
