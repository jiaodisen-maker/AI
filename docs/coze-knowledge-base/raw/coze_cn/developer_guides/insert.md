---
source_url: https://docs.coze.cn/developer_guides/insert
title: '插入数据 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:23:19Z
---
...
权限​| Database.createRecord​确保调用该接口使用的访问令牌开通了Database.createRecord权限，详细信息参考[鉴权方式](<https://docs.coze.cn/developer_guides/authentication>)。​  
接口说明​| 向数据库中插入一条或多条记录。​  
...
参数​| 类型​| 是否必选​| 示例​| 说明​  
---|---|---|---|---  
insert_rows​| Array of JSON Map​| 必选​| [{"user_id": "alice","level":"1"},{"user_id": "molly", "level": "2"}]​| 需要插入的数据列表，每条记录为一个字段到值的映射。所有值均为字符串类型，系统会根据表结构自动转换。单次最大支持 1000条记录。​  
...
a.登录[扣子编程](<https://code.coze.cn/home>)。​

b.单击页面左下角的个人头像，进入个人主页页面。​

c.个人主页 URL 中的数字串即为渠道 UID，例如https://code.coze.cn/u/23903235371****中的 23903235371****。​
...
参数​| 类型​| 示例​| 说明​  
---|---|---|---  
data​| Object of [InsertData](<https://docs.coze.cn/developer_guides/insert#insertdata>)​| {"affected_rows":3}​| 已插入的数据信息。​  
code​| Long​| 0​| 调用状态码。​
...
detail​| Object of [ResponseDetail](<https://docs.coze.cn/developer_guides/insert#responsedetail>)​| {"logid":"20241210152726467C48D89D6DB2****"}​| 包含请求的详细信息的对象，主要用于记录请求的日志 ID 以便于排查问题。​  
