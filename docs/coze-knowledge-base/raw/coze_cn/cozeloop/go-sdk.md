---
source_url: https://docs.coze.cn/cozeloop/go-sdk
title: '快速开始 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:56:04Z
---
...
本文指导你如何安装并使用扣子罗盘 SDK 进行 Trace 数据上报、Prompt 拉取等操作。 ​

说明

扣子罗盘提供多种语言的开发工具包。本教程专注于 Go 语言开发，其他语言的使用说明请参考：​
...
在使用扣子罗盘 Go SDK 前，确保你已经完成了授权。详情请参考​SDK 鉴权。​
...
首先，通过环境变量的方式完成授权。​
  ...
  * 该示例中使用了 PAT 授权方式，你可以使用 OAuth 方式进行授权。具体说明，请参考​SDK 鉴权。​
