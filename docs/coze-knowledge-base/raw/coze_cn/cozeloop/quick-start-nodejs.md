---
source_url: https://docs.coze.cn/cozeloop/quick-start-nodejs
title: '快速开始 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:56:24Z
---
...
扣子罗盘提供多种语言的开发工具包。本教程专注于 Node.js 语言开发，其他语言的使用说明请参考：​
...
在使用扣子罗盘 Node SDK 前，确保你已经完成了授权。详情请参考​SDK 鉴权。​
...
示例代码：[https://github.com/coze-dev/cozeloop-js/tree/main/examples/cozeloop-ai-node/src](<https://github.com/coze-dev/cozeloop-js/tree/main/examples/cozeloop-ai-node/src>)​

Trace 上报​

Tracer 初始化​

完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/index.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/index.ts>)​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/root.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/root.ts>)​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/basic.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/basic.ts>)​

扣子罗盘支持在任何关键节点进行自定义 span 上报，并自由设置关键信息和自定义 tag。每个traceable所包装的[span](<https://opentelemetry.io/docs/concepts/signals/traces/#spans>)实例将透传给内部业务方法，使用者可以在方法中消费。​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/llm.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/llm.ts>)​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/large-text.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/large-text.ts>)​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/multi-modality.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/multi-modality.ts>)​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/transfer-between-services.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/transfer-between-services.ts>)​

1.

当需要得到当前上下文，并提供给下游服务时：​
...
​
  ...
  * 【标准[W3C协议](<https://www.w3.org/TR/trace-context/>)上下文】你可以通过propagation.inject来将上下文信息注入headers：​
...
​
  ...
  * 【标准[W3C协议](<https://www.w3.org/TR/trace-context/>)上下文】你可以使用propagation.extract并传入带有标准W3C协议的 headers 来得到 Context：​
...
完整示例：[https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/prompt/hub.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/prompt/hub.ts>)​

在使用 SDK 拉取 Prompt 前，需要在扣子罗盘的 Prompt 开发页面获取 Prompt Key 和版本号。​

​

​​![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%272826%27%20height=%27669.3157894736842%27/%3e)![](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjgyNiIgaGVpZ2h0PSI2NjkuMzE1Nzg5NDczNjg0MiIgdmVyc2lvbj0iMS4xIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)​
...
Trace​​| [index.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/index.ts>)​| 了解如何进行 Tracer 初始化。​  
...
​| [llm.ts](<https://github.com/coze-dev/cozeloop-js/blob/main/examples/cozeloop-ai-node/src/tracer/llm.ts>)​​| 了解 model span 的上报，包括上报模型相关的各种参数以及标准化的 Input / Output 上报。​  
