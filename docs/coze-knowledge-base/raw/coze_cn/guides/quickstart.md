---
source_url: https://docs.coze.cn/guides/quickstart
title: '搭建一个 AI 助手智能体 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:31:46Z
---
...
你可以单击自动优化提示词，让大语言模型将提示词优化为结构化内容。更多详细信息，参考​编写提示词。​
