---
source_url: https://docs.coze.cn/guides/icon_web
title: '图标 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:38:30Z
---
...
​​![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27190%27%20height=%27196%27/%3e)![](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTkwIiBoZWlnaHQ9IjE5NiIgdmVyc2lvbj0iMS4xIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)​
...
悬浮效果​| 配置图标组件的悬浮态效果。具体配置说明如下：​
  ...
  * 样式效果：当鼠标悬浮到图标组件上时，图标组件的样式变化情况。包括背景色、边框等。详细说明，请参考​样式设置。​

  * 变换效果：当鼠标悬浮到图标组件上时，图标组件的动态变化情况。包括缩放、旋转等。详细说明，请参考​状态设置。​
...
点击效果​| 配置图标组件的点击态效果。具体配置说明如下：​
  ...
  * 变换效果：点击图标组件时，图标组件的动态变化情况。详细说明，请参考​状态设置。​
...
控制图标组件隐藏或显示的参数，支持在特定条件下隐藏图标组件。​
  ...
  * 例如可以通过开关组件控制图标组件的可见性。开关组件 ID 为 Switch 1，当你将图标组件的可见性设置为{{ Switch1.value}}后，开关打开时，{{ Switch1.value}}值为 true，图标组件将被隐藏。​
