---
source_url: https://docs.coze.cn/guides/workflow
title: '低代码工作流介绍 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:33:10Z
---
...
​​![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27500%27%20height=%27219%27/%3e)![](https://p9-arcosite.byteimg.com/https://p9-arcosite.byteimg.com/obj/tos-cn-i-goo7wpa0wc/2ace7468d57b4575b57cba7156561faf~tplv-goo7wpa0wc-quality:q75.image)​
...
在低代码工作流中使用付费节点时，扣子编程将按照对应节点的计费规则收费。例如，在低代码工作流中添加视频生成节点，该节点运行成功即会产生模型 token 费用。扣子编程提供如下付费节点：​
  ...
  * 模型节点：​大模型节点、​意图识别节点、​问答节点、​视频生成节点等会产生模型 token 费用。模型计费说明，请参考​模型费用。​

  * 功能节点：​图像生成节点、​知识库写入节点、​长期记忆写入节点、​长期记忆检索节点等按照对应节点的计费规则收费。​

  * 插件节点：使用官方付费插件和三方付费插件时，将根据插件调用量（次数、时长等）计费。插件计费说明，请参考​插件费用。​
...
说明
  ...
  * 低代码工作流的所有者可以为低代码工作流开启多人协作模式，并添加协作者。详情请参考​权限说明。​
