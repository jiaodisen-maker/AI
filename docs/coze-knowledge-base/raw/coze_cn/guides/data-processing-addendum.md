---
source_url: https://docs.coze.cn/guides/data-processing-addendum
title: '扣子数据处理协议 - 文档 - 扣子'
site: coze_cn
scraped_at: 2026-05-04T14:47:50Z
---
...
除上下文另有所指外，DPA中下列词汇具有以下涵义：​
  ...
  * “开发者数据”指：(1）开发者利用扣子功能/服务获得或创建聊天机器人（Bot）时上传的全部数据（例如数据库信息、开发者上传的插件/api信息等），以及（2）开发者发布聊天机器人（Bot）后该bot运行期间经由扣子处理的所有数据，包括所有文本、声音、视频或图像文件以及软件，也包括开发者因使用扣子产品或服务而衍生的开发者可自主控制和管理的数据（如配置数据、运维数据等）。​
  ...
  * “受托方”是指代表委托方处理数据的任何组织或个人（委托方的雇员除外），DPA下指扣子。​

  * “数据保护要求”是指《中华人民共和国个人信息保护法》、《中华人民共和国网络安全法》有关数据保护的条款以及与个人信息处理与隐私相关的其他所有适用法律法规，包括适用的任何国家或地方监管机构颁布的指导意见、建议、通告和行业守则。​

  * “获准转委托方”是指受托方扣子所使用的负责处理开发者数据和个人信息的其他处理方。​

  * DPA中其他相关术语，除非另有说明，否则其定义与扣子协议中的定义相同，如未进行定义则采用法律法规、行政规章、国家标准（包含推荐性标准或其届时已经公布的征求意见稿）等文件中的解释。​
...
开发者同意，扣子协议（包括 DPA 条款和任何适用的更新）连同开发者使用和配置扣子相关功能的说明文档以及开发者对专业服务的使用，系开发者就个人信息的处理向扣子作出的完整的指示。开发者可以在[coze](<http://coze.cn>)[.cn](<http://coze.cn/>)或包含本 DPA 的其他协议中找到有关产品的使用和配置的信息。​
